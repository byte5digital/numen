    ...
    public function index(
        ...
        $providers = [
            ...
            [
                'name' => 'openai',
                'label' => 'OpenAI',
                'available' => $openai->isAvailable('gpt-4o'),
                'key_set' => ! empty(config('numen.providers.openai.api_key')),
                'default_model' => config('numen.providers.openai.default_model', 'gpt-4o'),
            ...
            [
                ...
                'available' => $azure->isAvailable('gpt-4o'),
                'key_set' => ! empty(config('numen.providers.azure.api_key')) && ! empty(config('numen.providers.azure.endpoint')),
                'default_model' => config('numen.providers.azure.default_model', 'gpt-4o'),
