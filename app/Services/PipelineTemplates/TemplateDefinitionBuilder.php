...
class TemplateDefinitionBuilder
{
    ...
    public function build(): array
    {
        ...
        if (! $result->isValid()) {
            throw new InvalidArgumentException('Invalid template definition: '.implode('; ', $result->errors()));
        }
    ...
    /**
     * Build without throwing; returns definition + ValidationResult.
     *
    ...
    public function buildWithValidation(): array
    {
        ...
        return ['definition' => $definition, 'result' => $this->validator->validate($definition)];
    }
}
