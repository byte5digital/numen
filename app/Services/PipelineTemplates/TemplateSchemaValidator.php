...
class TemplateSchemaValidator
{
    ...
    /** @param array<int, mixed> $stages @return array<string> */
    ...
    /** @param array<int, mixed> $personas @return array{0: array<string>, 1: array<string>} */
    ...
    /** @param array<string, mixed> $settings @return array<string> */
    ...
    /** @param array<int, mixed> $variables @return array<string> */
    ...
    /** @param array<int, mixed> $stages @param array<string> $personaRefs @return array<string> */
    ...
    /** @param array<int, mixed> $personas @return array<string> */
