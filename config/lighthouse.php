...
return [
    ...
    */
    ...
    'route' => [
         ...
         */
        'middleware' => [
            // Authenticate via Sanctum when token is present
    ...
    */
    ...
    'security' => [
        'max_query_complexity' => env('LIGHTHOUSE_MAX_COMPLEXITY', 500),
        'max_query_depth' => env('LIGHTHOUSE_MAX_DEPTH', 10),
    ...
    */
    ...
    'subscriptions' => [
         ...
         */
        'storage' => env('LIGHTHOUSE_SUBSCRIPTION_STORAGE', 'array'),
